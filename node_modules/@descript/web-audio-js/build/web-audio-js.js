...
function getWorkletProcessor(audioContext, name) {
    var _a;
    return (_a = workletProcessors.get(audioContext)) === null || _a === void 0 ? void 0 : _a.get(name);
}
function registerProcessor(audioContext, name, Processor) {
...
class AudioWorklet {
    ...
    addModule(_url, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((options === null || options === void 0 ? void 0 : options.processorCtor) && (options === null || options === void 0 ? void 0 : options.name)) {
                registerProcessor(this.audioContext, options.name, options.processorCtor);
                return null;
            }
            throw new Error('Cannot load audio worklet via url in web-audio-js. Pass name and processorCtr in options');
        });
    }
}
        ...
        MC =
            ...
            typeof MessageChannel === 'function'
                ? // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
                    // @ts-ignore
                    MessageChannel
                : (_a = require('worker_threads')) === null || _a === void 0 ? void 0 : _a.MessageChannel;
    }
    if (!MC) {
...
function AudioWorkletNode(context, name, options = {}) {
    ...
    128, outputChannels, outputChannels);
    const scriptProcessorParameters = new Map();
    ...
    if (Processor.parameterDescriptors) {
        for (let i = 0; i < Processor.parameterDescriptors.length; i++) {
            ...
            const audioParam = new AudioParam$1(context, new AudioParam(context, {
    ...
    function getUpdatedParameters() {
        if (!parameters) {
            ...
            for (const [key, audioParam] of scriptProcessorParameters.entries()) {
                const size = audioParam.automationRate === 'k-rate'
                    ? 1
...
class AudioWorkletProcessor {
    ...
    process(_input, _output, _parameters) {
...
class BaseAudioContext extends EventTarget$1 {
  ...
  get audioWorklet() {
    return (
      this._audioWorklet || (this._audioWorklet = new AudioWorklet(this))
    );
  }
